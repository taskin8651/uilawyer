...
class UpdateVerdictJudgmentRequest extends FormRequest
{
    public function authorize()
    {
        return Gate::allows('verdict_judgment_edit');
    }
    ...
    public function rules()
    {
        return [
            ...
            'slug' => 'nullable|string|max:255|unique:verdict_judgments,slug,' . request()->route('verdict_judgment')->id,
